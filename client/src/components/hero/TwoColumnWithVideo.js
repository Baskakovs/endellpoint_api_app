...
const PrimaryButton = tw.button`font-bold px-8 lg:px-10 py-3 rounded cursor-pointer text-gray-100 focus:shadow-outline focus:outline-none transition duration-300`;
...
export default ({
  heading = "Welcome to Endell",
 description="Our parcel collection points will save you from the frustration of delayed or missed deliveries, making your online shopping hassle-free.",
